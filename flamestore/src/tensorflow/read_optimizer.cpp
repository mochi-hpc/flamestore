...
class ReadOptimizerOp : public OpKernel {
...
public:
    ...
    explicit ReadOptimizerOp(OpKernelConstruction* context)
    : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("ReadOptimizer").Device(DEVICE_CPU), ReadOptimizerOp);
